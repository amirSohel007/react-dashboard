								...
								<Row className='justify-content-center'>
									<Col md='8'>
										<div className='header-text'>
											<Card.Title as='h2'>Light Bootstrap Dashboard PRO</Card.Title>
											<Card.Subtitle as='h4'>
									...
									<Col className='ml-auto' md='7' lg='5'>
										<Media>
											...
											<Media.Body>
												<h4>Free Account</h4>
												<p>
													Here you can write a feature description for your dashboard, let the users
													know what is the value that you give them.
												</p>
											</Media.Body>
										</Media>
										<Media>
										...
										<Form action='#' method='#'>
											<Card className='card-plain'>
												<div className='card-body'>
													<Form.Group>
														<Form.Control placeholder='Your First Name' type='email'></Form.Control>
													</Form.Group>
													<Form.Group>
														<Form.Control placeholder='Your Last Name' type='email'></Form.Control>
													</Form.Group>
													<Form.Group>
