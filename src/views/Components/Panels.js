								...
								<Tab.Container id='plain-tabs-example' defaultActiveKey='info-plain'>
									...
									<Tab.Content>
										<Tab.Pane eventKey='info-plain'>
											Agency is a group of professional individuals looking to create amazing pieces
											of clothing. We have studied at the best schools of design, we have tailored
											the suits for the most stylish men in the industry, we are what you need!
										</Tab.Pane>
										<Tab.Pane eventKey='account-plain'>
											We are Houses Inc., a group of architects and interior designers based in
										...
										<Tab.Pane eventKey='style-plain'>
											Explore a wide variety of styles, personalise your finishes, and let us design
											the perfect home for you. It
											{"'"}s what we do best and you can see proof in the products and reviews
											below.
										</Tab.Pane>
										<Tab.Pane eventKey='settings-plain'>
											Explore a wide Houses Inc., a group of architects and interior designers based
											in Chicago and operating for clients worldwide. We’ve been designing
											stunningly beautiful houses and making clients happy for years.
										</Tab.Pane>
									</Tab.Content>
								</Tab.Container>
							</Card.Body>
							...
							<Tab.Content>
									...
									<Card>
										...
										<Card.Body>
											<p>
												...
												efficient. With a smooth metal surface that seamlessly meets the new Retina
												HD display.
											</p>
											<p>
												The first thing you notice when you hold the phone is how great it feels in
												your hand. There are no distinct edges. No gaps. Just a smooth, seamless
												bond of metal and glass that feels like one continuous surface.
											</p>
										</Card.Body>
									</Card>
								</Tab.Pane>
								<Tab.Pane eventKey='location-page-subcategories'>
									<Card>
										...
										<Card.Body>
											<p>
												Another Text. The first thing you notice when you hold the phone is how
											...
											<p>
												...
												software function in perfect unison, creating a new generation of phone
