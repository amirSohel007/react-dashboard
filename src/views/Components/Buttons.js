							...
							<Card>
								<Row>
									...
									<Col md='6'>
										...
										<Card.Body>
											...
											<Button className='btn-outline btn-wd mr-1' variant='default'>
												Outline
											</Button>
											<Button className='btn-round btn-wd mr-1' variant='default'>
												Fill + Round
											</Button>
								...
								<Row>
									<Col md='6'>
										...
										<Card.Body>
											<Button className='btn-wd btn-outline mr-1' type='button' variant='success'>
												<span className='btn-label'>
													<i className='fas fa-check'></i>
												</span>
												Success
											</Button>
											<Button className='btn-wd btn-outline mr-1' type='button' variant='danger'>
												<span className='btn-label'>
													<i className='fas fa-times'></i>
												</span>
												Danger
											</Button>
											<Button className='btn-wd btn-outline mr-1' type='button' variant='info'>
												<span className='btn-label'>
													<i className='fas fa-exclamation'></i>
												</span>
												Info
											</Button>
											<Button className='btn-wd btn-outline mr-1' type='button' variant='warning'>
												<span className='btn-label'>
													<i className='fas fa-exclamation-triangle'></i>
												</span>
												Warning
											</Button>
											<Button className='btn-wd btn-outline mr-1' type='button' variant='default'>
												<span className='btn-label'>
													<i className='fas fa-arrow-left'></i>
												</span>
												Left
											</Button>
											<Button className='btn-wd btn-outline' type='button' variant='default'>
												Right{' '}
									...
									<Col md='6'>
										...
										<Card.Body>
											...
											<br></br>
											<Button className='btn-round mr-1' size='lg' variant='default'>
												Large
											</Button>
								...
								<Card.Body>
									<Row>
										...
										<Col className='social-buttons-demo' md='2' sm='2' xs='3'>
											...
											<Button className='btn-social btn-round btn-outline' variant='twitter'>
												<i className='fab fa-twitter'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='facebook'>
												<i className='fab fa-facebook'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='google'>
												<i className='fab fa-google-plus'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='linkedin'>
												<i className='fab fa-linkedin'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='pinterest'>
												<i className='fab fa-pinterest'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='youtube'>
												<i className='fab fa-youtube'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='tumblr'>
												<i className='fab fa-tumblr'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='github'>
												<i className='fab fa-github'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='behance'>
												<i className='fab fa-behance'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='dribbble'>
												<i className='fab fa-dribbble'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='reddit'>
												<i className='fab fa-reddit'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-round btn-outline' variant='stumbleupon'>
												<i className='fab fa-stumbleupon'></i>
											</Button>
											<br></br>
										</Col>
										<Col className='social-buttons-demo' md='2' sm='2' xs='3'>
											...
											<br></br>
											<Button className='btn-social btn-link' variant='facebook'>
												<i className='fab fa-facebook-square'></i>
											</Button>
											<br></br>
											...
											<br></br>
											<Button className='btn-social btn-link' variant='linkedin'>
												<i className='fab fa-linkedin'></i>
											</Button>
											<br></br>
											<Button className='btn-social btn-link' variant='pinterest'>
												<i className='fab fa-pinterest'></i>
											</Button>
											<br></br>
											...
											<br></br>
											<Button className='btn-social btn-link' variant='dribbble'>
												<i className='fab fa-dribbble'></i>
											</Button>
											<br></br>
											...
											<br></br>
											<Button className='btn-social btn-link' variant='stumbleupon'>
												<i className='fab fa-stumbleupon'></i>
											</Button>
											<br></br>
										</Col>
