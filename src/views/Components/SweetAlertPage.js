	...
	const htmlAlert = () => {
		setAlert(
			<SweetAlert
				...
				<a href='https://www.creative-tim.com/?ref=lbdpr-sweetalert-page' target='_blank'>
					links
				</a>{' '}
				and other HTML tags
			</SweetAlert>,
				...
				<Card className='card-plain'>
					...
					<p className='category'>
						<span>
							...
							<a href='https://github.com/djorg83/react-bootstrap-sweetalert' target='_blank'>
								full documentation
							</a>
							.
						</span>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										<h5>Basic example</h5>
										<Button className='btn-fill' onClick={basicAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										...
										<Button className='btn-fill' onClick={titleAndTextAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										...
										<Button className='btn-fill' onClick={successAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										...
										<Button className='btn-fill' onClick={htmlAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										...
										<Button className='btn-fill' onClick={autoCloseAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
							...
							<Col md='3'>
								<Card>
									<Card.Body className='text-center'>
										...
										<Button className='btn-fill' onClick={inputAlert} variant='default'>
											Try me!
										</Button>
									</Card.Body>
								</Card>
