							...
							<Card.Body>
								<Form action='#' method='#'>
									<Form.Group>
										...
										<Form.Control placeholder='Enter email' type='email'></Form.Control>
									</Form.Group>
									<Form.Group>
									...
									<fieldset>
										<Form.Group>
											<Row>
												...
												<Col sm='10'>
													<Form.Control placeholder='placeholder' type='text'></Form.Control>
												</Col>
											</Row>
										</Form.Group>
									</fieldset>
											...
											<Row>
												...
												<Col sm='10'>
													<Form.Control
														plaintext
														tag='p'
														defaultValue='hello@creative-tim.com'></Form.Control>
												</Col>
											</Row>
										</Form.Group>
									</fieldset>
							...
							<Card.Body>
								<Form action='/' className='form-horizontal' method='get'>
									<Row>
										...
										<Col className='checkbox-radios' sm={{ span: 4, offset: 1 }}>
											<Form.Check>
												<Form.Check.Label>
									...
									<Row>
										...
										<Col sm='10'>
											<Form.Group className='has-success'>
												<Form.Control defaultValue='Success' type='text'></Form.Control>
											</Form.Group>
										</Col>
									</Row>
									<Row>
										...
										<Col sm='10'>
											<Form.Group className='has-error'>
												<Form.Control defaultValue='Error' type='text'></Form.Control>
											</Form.Group>
										</Col>
									</Row>
									<Row>
										...
										<Col sm='10'>
											<Row>
												<Col md='3'>
													<Form.Group>
														<Form.Control placeholder='.col-md-3' type='text'></Form.Control>
													</Form.Group>
												</Col>
												<Col md='4'>
													<Form.Group>
														<Form.Control placeholder='.col-md-4' type='text'></Form.Control>
													</Form.Group>
												</Col>
												<Col md='5'>
													<Form.Group>
														<Form.Control placeholder='.col-md-5' type='text'></Form.Control>
													</Form.Group>
												</Col>
											</Row>
										</Col>
