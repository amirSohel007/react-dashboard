						...
						<Form action='' id='RegisterValidation' method=''>
							<Card>
								...
								<Card.Body>
									...
									<Form.Group
										className={
											'has-label ' + (registerPasswordState ? 'has-success' : 'has-error')
										}>
										<label>
									...
									<Form.Group
										className={
											'has-label ' + (registerConfirmPasswordState ? 'has-success' : 'has-error')
										}>
										<label>
										...
										{registerConfirmPassword ? null : (
											<label className='error'>
												This field is required and needs to be equal with the one above.
											</label>
										)}
									</Form.Group>
								...
								<Card.Footer className='text-right'>
									<Button
										...
										variant='info'
										onClick={() => {
											if (!registerEmailState || !emailValidation(registerEmail)) {
												setRegisterEmailState(false);
											} else {
												setRegisterEmailState(true);
											}
											if (!registerPasswordState || !minLength(registerPassword, 1)) {
												setRegisterPasswordState(false);
											} else {
												setRegisterPasswordState(true);
											}
							...
							<Card>
								...
								<Card.Body>
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={typeRequiredState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='required'
													type='text'
													value={typeRequired}
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={typeEmailState ? 'has-success' : 'has-error'}>
												...
												{typeEmailState ? null : (
													<label className='error'>This field is required to be an email.</label>
												)}
											</Form.Group>
										</Col>
										<Col className='label-on-right' sm='3'>
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={typeNumberState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='number'
													type='text'
													value={typeNumber}
												...
												{typeNumberState ? null : (
													<label className='error'>This field is required to be a number.</label>
												)}
											</Form.Group>
										</Col>
										<Col className='label-on-right' sm='3'>
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={typeURLState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='url'
													type='text'
													value={typeURL}
												...
												{typeURLState ? null : (
													<label className='error'>This field is required to be a valid URL.</label>
												)}
											</Form.Group>
										</Col>
										<Col className='label-on-right' sm='3'>
										...
										<Col sm='3'>
											<Form.Group>
												<Form.Control
													...
													type='text'
													value={typeEqualTo1}
													onChange={(e) => setTypeEqualTo1(e.target.value)}></Form.Control>
											</Form.Group>
										</Col>
										<Col sm='3'>
											<Form.Group className={typeEqualTo2State ? 'has-success' : 'has-error'}>
												<Form.Control
													equalto='#idSource'
													id='idDestination'
								...
								<Card.Footer className='text-center'>
									<Button
										...
										onClick={() => {
											...
											if (!typeEqualTo2State || !equalTo(typeEqualTo1, typeEqualTo2)) {
												setTypeEqualTo2State(false);
											} else {
												setTypeEqualTo2State(true);
											}
							...
							<Card>
								...
								<Card.Body>
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={rangeMinLengthState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='min_length'
													type='text'
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={rangeMaxLengthState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='max_length'
													type='text'
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={rangeRangeState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='range'
													type='text'
													value={rangeRange}
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={rangeMinValueState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='min'
													type='text'
													value={rangeMinValue}
									...
									<Row>
										...
										<Col sm='7'>
											<Form.Group className={rangeMaxValueState ? 'has-success' : 'has-error'}>
												<Form.Control
													name='max'
													type='text'
													value={rangeMaxValue}
								...
								<Card.Footer className='text-center'>
									<Button
										variant='info'
										onClick={() => {
											if (!rangeMinLengthState || !minLength(rangeMinLength, 5)) {
												setRangeMinLengthState(false);
											} else {
												setRangeMinLengthState(true);
											}
											if (!rangeMaxLengthState || !maxLength(rangeMaxLength, 5)) {
												setRangeMaxLengthState(false);
											} else {
												setRangeMaxLengthState(true);
											}
