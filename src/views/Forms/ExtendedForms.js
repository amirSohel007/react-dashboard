...
function ExtendedForms() {
	const [regularTags, setRegularTags] = React.useState(['pizza', 'pasta', 'parmesan']);
	const [filledTags, setFilledTags] = React.useState(['pizza', 'pasta', 'parmesan']);
								...
								<Col md='4'>
									...
									<Form.Group>
										<ReactDatetime
											...
											timeFormat={false}></ReactDatetime>
									</Form.Group>
								</Col>
								<Col md='4'>
								...
								<Col md='6'>
									...
									<Row>
										...
										<Col md='4'>
											...
											<Form.Check disabled type='switch' id='custom-switch-21' className='mb-1' />
											<Form.Check disabled type='switch' id='custom-switch-22' defaultChecked />
