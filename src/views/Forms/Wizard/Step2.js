...
const Step2 = React.forwardRef((props, ref) => {
	...
	const isValidated = () => {
		...
		try {
			...
			setWebsiteError(<small className='text-danger'>Must be a valid URL!</small>);
			wb = false;
		}
		languageSelect === null
			? setLanguageError(<small className='text-danger'>You have to select a language.</small>)
	...
	return (
		<div className='wizard-step'>
			<p className='text-center mt-4'>Please give us more details about your platform.</p>
			<Row>
