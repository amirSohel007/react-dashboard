	...
	const notify = (place) => {
		...
		options = {
			...
			message: (
				<div>
					<div>
						Welcome to <b>Black Dashboard React</b> - a beautiful premium admin for every web
						developer.
					</div>
				</div>
			),
	...
	return (
		<>
			...
			<Container fluid>
					...
					<Card.Header>
						...
						<p className='card-category'>
							<span>
								...
								. Please checkout the{' '}
								<a href='https://github.com/igorprado/react-notification-system' target='_blank'>
									full documentation.
								</a>
							</span>
						</p>
					...
					<Card.Body>
						<Row>
							<Col md='6'>
								...
								<Alert variant='info'>
									<button aria-hidden={true} className='close' data-dismiss='alert' type='button'>
						...
						<Row>
							<Col className='text-center' md='12'>
								...
								<Button className='btn-fill btn-wd' onClick={() => setModal(!modal)} variant='info'>
									Launch Modal Mini
								</Button>
							</Col>
						</Row>
				...
				{/* Mini Modal */}
				<Modal className='modal-mini modal-primary' onHide={() => setModal(!modal)} show={modal}>
